...
CREATE TABLE IF NOT EXISTS ACCOUNT (
    ...
    VIP_EXPIRACY DATETIME DEFAULT NULL,

    MUTED_TIME INTEGER UNSIGNED NOT NULL DEFAULT 0,
    WANTED_LEVEL TINYINT UNSIGNED NOT NULL DEFAULT 0,
    JAIL_TIME INTEGER UNSIGNED NOT NULL DEFAULT 0,
    BONUS BOOLEAN NOT NULL DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS VEHICLE_TRUNK (
    ...
    FOREIGN KEY(VEHICLE_ID) REFERENCES PLAYER_VEHICLES(VEHICLE_ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS GUIDES (
    ID INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    UUID VARCHAR(36) NOT NULL UNIQUE,
    AUTHOR VARCHAR(32) NOT NULL DEFAULT 'Hyaxe',
	TITLE TEXT NOT NULL DEFAULT 'Without title',
    CONTENT LONGTEXT NOT NULL DEFAULT 'Without body',
    DATE DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS PLAYER_COSMETICS (
    ...
    NAME VARCHAR(32) NOT NULL DEFAULT 'Player Cosmetic',
    ...
    MATERIAL_COLOR_ONE INT NOT NULL DEFAULT 0,
    MATERIAL_COLOR_TWO INT NOT NULL DEFAULT 0,
