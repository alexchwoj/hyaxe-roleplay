...
static Crack_OnUse(playerid, slot)
{
    ...
    {
        Notification_ShowBeatingText(playerid, 2000, 0xED2B2B, 100, 255, va_return("Debes esperar %d segundos para consumir crack", ((gettime() - (g_rgePlayerTempData[playerid][e_iMedicineUseTime] - (Player_VIP(playerid) >= 3 ? 3 : 10))))));
        return 1;
    }
...
public OnScriptInit()
{
    ...
    Item_SetPreviewRot(ITEM_KNIFE, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_BAT, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SHOVEL, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_POOLSTICK, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_KATANA, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_CHAINSAW, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_DILDO, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_DILDO2, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_VIBRATOR, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_VIBRATOR2, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_FLOWER, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_CANE, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_GRENADE, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_TEARGAS, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_MOLTOV, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_COLT45, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SILENCED, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_DEAGLE, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SHOTGUN, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SAWEDOFF, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SHOTGSPA, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_UZI, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_MP5, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_AK47, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_M4, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_TEC9, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_RIFLE, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SNIPER, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_ROCKETLAUNCHER, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_HEATSEEKER, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_FLAMETHROWER, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_MINIGUN, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SATCHEL, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_BOMB, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_SPRAYCAN, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_FIREEXTINGUISHER, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_CAMERA, -15.000000, 0.000000, 30.000000, 1.000000);
    Item_SetPreviewRot(ITEM_PARACHUTE, -15.000000, 0.000000, 30.000000, 1.000000);
