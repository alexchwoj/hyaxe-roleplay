...
* 'configure.py --cpu x86 --cc clang --os linux --amalgamation --minimized-build --disable-shared --enable-modules=argon2,base64,system_rng'
*
* Target
...
#define BOTAN_VERSION_DATESTAMP 20220603
