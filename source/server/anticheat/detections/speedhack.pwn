...
IPacket:__ac_sh_PlayerSync(playerid, BitStream:bs)
{
    ...
    if((floatabs(velocity_x) > 0.31 || floatabs(velocity_y) > 0.31) && (1222 <= animation_id <= 1287) && !surfing_vehicle_id && GetPlayerSpecialAction(playerid) != SPECIAL_ACTION_USEJETPACK)
    {
