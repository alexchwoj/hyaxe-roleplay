...
public OnPlayerEnterDynamicCP(playerid, checkpointid)
{
    ...
    { 
        ...
        else if(checkpointid == g_iTruckerCentralCp)
        {
            ...
            new pay = floatround(VectorSize(125.2116 - g_rgeTruckerRoutes[route][e_fTruckCpX], -285.1135 - g_rgeTruckerRoutes[route][e_fTruckCpY], 1.5781 - g_rgeTruckerRoutes[route][e_fTruckCpZ])) * 10;
