...
public OnGameModeInit()
{
    ...
    // Gang member slots
    g_tdGangMemberSlots[0][0] = TextDrawCreate(317.000000, 140.000000, "_");
    TextDrawFont(g_tdGangMemberSlots[0][0], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[0][0], 0.600000, 2.149955);
    TextDrawTextSize(g_tdGangMemberSlots[0][0], 307.000000, 126.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[0][0], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[0][0], 0);
    TextDrawAlignment(g_tdGangMemberSlots[0][0], 2);
    TextDrawColor(g_tdGangMemberSlots[0][0], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[0][0], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[0][0], 454761471);
    TextDrawUseBox(g_tdGangMemberSlots[0][0], 1);
    TextDrawSetProportional(g_tdGangMemberSlots[0][0], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[0][0], 0);

    g_tdGangMemberSlots[0][1] = TextDrawCreate(255.000000, 133.000000, "~r~.");
    TextDrawFont(g_tdGangMemberSlots[0][1], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[0][1], 0.600000, 2.000000);
    TextDrawTextSize(g_tdGangMemberSlots[0][1], 400.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[0][1], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[0][1], 0);
    TextDrawAlignment(g_tdGangMemberSlots[0][1], 1);
    TextDrawColor(g_tdGangMemberSlots[0][1], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[0][1], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[0][1], 50);
    TextDrawUseBox(g_tdGangMemberSlots[0][1], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[0][1], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[0][1], 0);

    g_tdGangMemberSlots[0][2] = TextDrawCreate(263.000000, 140.000000, "Ra_Cist");
    TextDrawFont(g_tdGangMemberSlots[0][2], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[0][2], 0.220833, 1.149999);
    TextDrawTextSize(g_tdGangMemberSlots[0][2], 436.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[0][2], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[0][2], 0);
    TextDrawAlignment(g_tdGangMemberSlots[0][2], 1);
    TextDrawColor(g_tdGangMemberSlots[0][2], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[0][2], 255);
    ...
    TextDrawLetterSize(g_tdGangMemberSlots[0][3], 0.150000, 0.800000);
    TextDrawTextSize(g_tdGangMemberSlots[0][3], 440.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[0][3], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[0][3], 0);
    TextDrawAlignment(g_tdGangMemberSlots[0][3], 1);
    TextDrawColor(g_tdGangMemberSlots[0][3], -993737473);
    TextDrawBackgroundColor(g_tdGangMemberSlots[0][3], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[0][3], 50);
    TextDrawUseBox(g_tdGangMemberSlots[0][3], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[0][3], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[0][3], 0);

    g_tdGangMemberSlots[1][0] = TextDrawCreate(317.000000, 168.000000, "_");
    TextDrawFont(g_tdGangMemberSlots[1][0], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[1][0], 0.600000, 2.149955);
    TextDrawTextSize(g_tdGangMemberSlots[1][0], 307.000000, 126.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[1][0], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[1][0], 0);
    TextDrawAlignment(g_tdGangMemberSlots[1][0], 2);
    TextDrawColor(g_tdGangMemberSlots[1][0], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[1][0], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[1][0], 454761471);
    TextDrawUseBox(g_tdGangMemberSlots[1][0], 1);
    TextDrawSetProportional(g_tdGangMemberSlots[1][0], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[1][0], 0);

    g_tdGangMemberSlots[1][1] = TextDrawCreate(255.000000, 162.000000, "~r~.");
    TextDrawFont(g_tdGangMemberSlots[1][1], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[1][1], 0.600000, 2.000000);
    TextDrawTextSize(g_tdGangMemberSlots[1][1], 400.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[1][1], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[1][1], 0);
    TextDrawAlignment(g_tdGangMemberSlots[1][1], 1);
    TextDrawColor(g_tdGangMemberSlots[1][1], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[1][1], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[1][1], 50);
    TextDrawUseBox(g_tdGangMemberSlots[1][1], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[1][1], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[1][1], 0);

    g_tdGangMemberSlots[1][2] = TextDrawCreate(263.000000, 168.000000, "Ra_Cist");
    TextDrawFont(g_tdGangMemberSlots[1][2], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[1][2], 0.220833, 1.149999);
    TextDrawTextSize(g_tdGangMemberSlots[1][2], 436.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[1][2], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[1][2], 0);
    TextDrawAlignment(g_tdGangMemberSlots[1][2], 1);
    TextDrawColor(g_tdGangMemberSlots[1][2], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[1][2], 255);
    ...
    TextDrawLetterSize(g_tdGangMemberSlots[1][3], 0.150000, 0.800000);
    TextDrawTextSize(g_tdGangMemberSlots[1][3], 440.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[1][3], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[1][3], 0);
    TextDrawAlignment(g_tdGangMemberSlots[1][3], 1);
    TextDrawColor(g_tdGangMemberSlots[1][3], -993737473);
    TextDrawBackgroundColor(g_tdGangMemberSlots[1][3], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[1][3], 50);
    TextDrawUseBox(g_tdGangMemberSlots[1][3], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[1][3], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[1][3], 0);

    g_tdGangMemberSlots[2][0] = TextDrawCreate(317.000000, 196.000000, "_");
    TextDrawFont(g_tdGangMemberSlots[2][0], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[2][0], 0.600000, 2.149955);
    TextDrawTextSize(g_tdGangMemberSlots[2][0], 307.000000, 126.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[2][0], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[2][0], 0);
    TextDrawAlignment(g_tdGangMemberSlots[2][0], 2);
    TextDrawColor(g_tdGangMemberSlots[2][0], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[2][0], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[2][0], 454761471);
    TextDrawUseBox(g_tdGangMemberSlots[2][0], 1);
    TextDrawSetProportional(g_tdGangMemberSlots[2][0], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[2][0], 0);

    g_tdGangMemberSlots[2][1] = TextDrawCreate(255.000000, 189.000000, "~r~.");
    TextDrawFont(g_tdGangMemberSlots[2][1], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[2][1], 0.600000, 2.000000);
    TextDrawTextSize(g_tdGangMemberSlots[2][1], 400.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[2][1], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[2][1], 0);
    TextDrawAlignment(g_tdGangMemberSlots[2][1], 1);
    TextDrawColor(g_tdGangMemberSlots[2][1], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[2][1], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[2][1], 50);
    TextDrawUseBox(g_tdGangMemberSlots[2][1], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[2][1], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[2][1], 0);

    g_tdGangMemberSlots[2][2] = TextDrawCreate(263.000000, 196.000000, "Ra_Cist");
    TextDrawFont(g_tdGangMemberSlots[2][2], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[2][2], 0.220833, 1.149999);
    TextDrawTextSize(g_tdGangMemberSlots[2][2], 436.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[2][2], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[2][2], 0);
    TextDrawAlignment(g_tdGangMemberSlots[2][2], 1);
    TextDrawColor(g_tdGangMemberSlots[2][2], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[2][2], 255);
    ...
    TextDrawLetterSize(g_tdGangMemberSlots[2][3], 0.150000, 0.800000);
    TextDrawTextSize(g_tdGangMemberSlots[2][3], 440.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[2][3], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[2][3], 0);
    TextDrawAlignment(g_tdGangMemberSlots[2][3], 1);
    TextDrawColor(g_tdGangMemberSlots[2][3], -993737473);
    TextDrawBackgroundColor(g_tdGangMemberSlots[2][3], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[2][3], 50);
    TextDrawUseBox(g_tdGangMemberSlots[2][3], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[2][3], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[2][3], 0);

    g_tdGangMemberSlots[3][0] = TextDrawCreate(317.000000, 224.000000, "_");
    TextDrawFont(g_tdGangMemberSlots[3][0], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[3][0], 0.600000, 2.149955);
    TextDrawTextSize(g_tdGangMemberSlots[3][0], 307.000000, 126.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[3][0], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[3][0], 0);
    TextDrawAlignment(g_tdGangMemberSlots[3][0], 2);
    TextDrawColor(g_tdGangMemberSlots[3][0], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[3][0], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[3][0], 454761471);
    TextDrawUseBox(g_tdGangMemberSlots[3][0], 1);
    TextDrawSetProportional(g_tdGangMemberSlots[3][0], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[3][0], 0);

    g_tdGangMemberSlots[3][1] = TextDrawCreate(255.000000, 217.000000, "~r~.");
    TextDrawFont(g_tdGangMemberSlots[3][1], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[3][1], 0.600000, 2.000000);
    TextDrawTextSize(g_tdGangMemberSlots[3][1], 400.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[3][1], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[3][1], 0);
    TextDrawAlignment(g_tdGangMemberSlots[3][1], 1);
    TextDrawColor(g_tdGangMemberSlots[3][1], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[3][1], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[3][1], 50);
    TextDrawUseBox(g_tdGangMemberSlots[3][1], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[3][1], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[3][1], 0);

    g_tdGangMemberSlots[3][2] = TextDrawCreate(263.000000, 224.000000, "Ra_Cist");
    TextDrawFont(g_tdGangMemberSlots[3][2], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[3][2], 0.220833, 1.149999);
    TextDrawTextSize(g_tdGangMemberSlots[3][2], 436.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[3][2], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[3][2], 0);
    TextDrawAlignment(g_tdGangMemberSlots[3][2], 1);
    TextDrawColor(g_tdGangMemberSlots[3][2], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[3][2], 255);
    ...
    TextDrawLetterSize(g_tdGangMemberSlots[3][3], 0.150000, 0.800000);
    TextDrawTextSize(g_tdGangMemberSlots[3][3], 440.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[3][3], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[3][3], 0);
    TextDrawAlignment(g_tdGangMemberSlots[3][3], 1);
    TextDrawColor(g_tdGangMemberSlots[3][3], -993737473);
    TextDrawBackgroundColor(g_tdGangMemberSlots[3][3], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[3][3], 50);
    TextDrawUseBox(g_tdGangMemberSlots[3][3], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[3][3], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[3][3], 0);

    g_tdGangMemberSlots[4][0] = TextDrawCreate(317.000000, 252.000000, "_");
    TextDrawFont(g_tdGangMemberSlots[4][0], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[4][0], 0.600000, 2.149955);
    TextDrawTextSize(g_tdGangMemberSlots[4][0], 307.000000, 126.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[4][0], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[4][0], 0);
    TextDrawAlignment(g_tdGangMemberSlots[4][0], 2);
    TextDrawColor(g_tdGangMemberSlots[4][0], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[4][0], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[4][0], 454761471);
    TextDrawUseBox(g_tdGangMemberSlots[4][0], 1);
    TextDrawSetProportional(g_tdGangMemberSlots[4][0], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[4][0], 0);

    g_tdGangMemberSlots[4][1] = TextDrawCreate(255.000000, 245.000000, "~r~.");
    TextDrawFont(g_tdGangMemberSlots[4][1], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[4][1], 0.600000, 2.000000);
    TextDrawTextSize(g_tdGangMemberSlots[4][1], 400.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[4][1], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[4][1], 0);
    TextDrawAlignment(g_tdGangMemberSlots[4][1], 1);
    TextDrawColor(g_tdGangMemberSlots[4][1], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[4][1], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[4][1], 50);
    TextDrawUseBox(g_tdGangMemberSlots[4][1], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[4][1], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[4][1], 0);

    g_tdGangMemberSlots[4][2] = TextDrawCreate(263.000000, 252.000000, "Ra_Cist");
    TextDrawFont(g_tdGangMemberSlots[4][2], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[4][2], 0.220833, 1.149999);
    TextDrawTextSize(g_tdGangMemberSlots[4][2], 436.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[4][2], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[4][2], 0);
    TextDrawAlignment(g_tdGangMemberSlots[4][2], 1);
    TextDrawColor(g_tdGangMemberSlots[4][2], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[4][2], 255);
    ...
    TextDrawLetterSize(g_tdGangMemberSlots[4][3], 0.150000, 0.800000);
    TextDrawTextSize(g_tdGangMemberSlots[4][3], 440.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[4][3], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[4][3], 0);
    TextDrawAlignment(g_tdGangMemberSlots[4][3], 1);
    TextDrawColor(g_tdGangMemberSlots[4][3], -993737473);
    TextDrawBackgroundColor(g_tdGangMemberSlots[4][3], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[4][3], 50);
    TextDrawUseBox(g_tdGangMemberSlots[4][3], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[4][3], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[4][3], 0);

    g_tdGangMemberSlots[5][0] = TextDrawCreate(317.000000, 280.000000, "_");
    TextDrawFont(g_tdGangMemberSlots[5][0], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[5][0], 0.600000, 2.149955);
    TextDrawTextSize(g_tdGangMemberSlots[5][0], 307.000000, 126.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[5][0], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[5][0], 0);
    TextDrawAlignment(g_tdGangMemberSlots[5][0], 2);
    TextDrawColor(g_tdGangMemberSlots[5][0], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[5][0], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[5][0], 454761471);
    TextDrawUseBox(g_tdGangMemberSlots[5][0], 1);
    TextDrawSetProportional(g_tdGangMemberSlots[5][0], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[5][0], 0);

    g_tdGangMemberSlots[5][1] = TextDrawCreate(255.000000, 273.000000, "~r~.");
    TextDrawFont(g_tdGangMemberSlots[5][1], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[5][1], 0.600000, 2.000000);
    TextDrawTextSize(g_tdGangMemberSlots[5][1], 400.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[5][1], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[5][1], 0);
    TextDrawAlignment(g_tdGangMemberSlots[5][1], 1);
    TextDrawColor(g_tdGangMemberSlots[5][1], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[5][1], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[5][1], 50);
    TextDrawUseBox(g_tdGangMemberSlots[5][1], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[5][1], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[5][1], 0);

    g_tdGangMemberSlots[5][2] = TextDrawCreate(263.000000, 280.000000, "Ra_Cist");
    TextDrawFont(g_tdGangMemberSlots[5][2], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[5][2], 0.220833, 1.149999);
    TextDrawTextSize(g_tdGangMemberSlots[5][2], 436.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[5][2], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[5][2], 0);
    TextDrawAlignment(g_tdGangMemberSlots[5][2], 1);
    TextDrawColor(g_tdGangMemberSlots[5][2], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[5][2], 255);
    ...
    TextDrawLetterSize(g_tdGangMemberSlots[5][3], 0.150000, 0.800000);
    TextDrawTextSize(g_tdGangMemberSlots[5][3], 440.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[5][3], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[5][3], 0);
    TextDrawAlignment(g_tdGangMemberSlots[5][3], 1);
    TextDrawColor(g_tdGangMemberSlots[5][3], -993737473);
    TextDrawBackgroundColor(g_tdGangMemberSlots[5][3], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[5][3], 50);
    TextDrawUseBox(g_tdGangMemberSlots[5][3], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[5][3], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[5][3], 0);

    g_tdGangMemberSlots[6][0] = TextDrawCreate(317.000000, 308.000000, "_");
    TextDrawFont(g_tdGangMemberSlots[6][0], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[6][0], 0.600000, 2.149955);
    TextDrawTextSize(g_tdGangMemberSlots[6][0], 307.000000, 126.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[6][0], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[6][0], 0);
    TextDrawAlignment(g_tdGangMemberSlots[6][0], 2);
    TextDrawColor(g_tdGangMemberSlots[6][0], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[6][0], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[6][0], 454761471);
    TextDrawUseBox(g_tdGangMemberSlots[6][0], 1);
    TextDrawSetProportional(g_tdGangMemberSlots[6][0], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[6][0], 0);

    g_tdGangMemberSlots[6][1] = TextDrawCreate(255.000000, 301.000000, "~r~.");
    TextDrawFont(g_tdGangMemberSlots[6][1], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[6][1], 0.600000, 2.000000);
    TextDrawTextSize(g_tdGangMemberSlots[6][1], 400.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[6][1], 1);
    TextDrawSetShadow(g_tdGangMemberSlots[6][1], 0);
    TextDrawAlignment(g_tdGangMemberSlots[6][1], 1);
    TextDrawColor(g_tdGangMemberSlots[6][1], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[6][1], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[6][1], 50);
    TextDrawUseBox(g_tdGangMemberSlots[6][1], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[6][1], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[6][1], 0);

    g_tdGangMemberSlots[6][2] = TextDrawCreate(263.000000, 308.000000, "Ra_Cist");
    TextDrawFont(g_tdGangMemberSlots[6][2], 1);
    TextDrawLetterSize(g_tdGangMemberSlots[6][2], 0.220833, 1.149999);
    TextDrawTextSize(g_tdGangMemberSlots[6][2], 436.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[6][2], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[6][2], 0);
    TextDrawAlignment(g_tdGangMemberSlots[6][2], 1);
    TextDrawColor(g_tdGangMemberSlots[6][2], -1);
    TextDrawBackgroundColor(g_tdGangMemberSlots[6][2], 255);
    ...
    TextDrawLetterSize(g_tdGangMemberSlots[6][3], 0.150000, 0.800000);
    TextDrawTextSize(g_tdGangMemberSlots[6][3], 440.000000, 17.000000);
    TextDrawSetOutline(g_tdGangMemberSlots[6][3], 0);
    TextDrawSetShadow(g_tdGangMemberSlots[6][3], 0);
    TextDrawAlignment(g_tdGangMemberSlots[6][3], 1);
    TextDrawColor(g_tdGangMemberSlots[6][3], -993737473);
    TextDrawBackgroundColor(g_tdGangMemberSlots[6][3], 255);
    TextDrawBoxColor(g_tdGangMemberSlots[6][3], 50);
    TextDrawUseBox(g_tdGangMemberSlots[6][3], 0);
    TextDrawSetProportional(g_tdGangMemberSlots[6][3], 1);
    TextDrawSetSelectable(g_tdGangMemberSlots[6][3], 0);
